...
export const LampContainer = ({ children, className }) => {
  return (
    <div
      ...
      style={{ backgroundColor: "#0e0c15" }} // Updated background color
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        >
          <div className="absolute w-[100%] left-0 bg-[#0e0c15] h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
          <div className="absolute w-40 h-[100%] left-0 bg-[#0e0c15] bottom-0 z-20 [mask-image:linear-gradient(to_right,white,transparent)]" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0.5, width: "15rem" }}
          whileInView={{ opacity: 1, width: "30rem" }}
        ...
        >
          <div className="absolute w-40 h-[100%] right-0 bg-[#0e0c15] bottom-0 z-20 [mask-image:linear-gradient(to_left,white,transparent)]" />
          <div className="absolute w-[100%] right-0 bg-[#0e0c15] h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
        </motion.div>
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-[#0e0c15] blur-2xl"></div>
        ...
        <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-[#0e0c15]"></div>
      </div>
